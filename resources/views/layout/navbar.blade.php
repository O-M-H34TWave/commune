<nav class="navbar navbar-expand-md navbar-light bg-light position-relative" style="height: 60px; overflow: visible;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-between align-items-center " id="collapseNavbar">
            <ul class="navbar-nav mb-0 ">
                ...
                <li class="nav-item">
                    <a href="{{route('services')}}" class="nav-link">خدمات</a>
                </li>
                <li class="nav-item pl-5">
                    <a href="{{route('news')}}" class="nav-link">أخبار الجماعة</a>
                </li>
                <li class="nav-item">
